...
import { CLASS_ROOMS_FEATURE_KEY, classUnitsReducer, ClassRoomsState } from './class-rooms.reducer';
import { ClassRoom } from '@school-diary/school-diary/domain';
import { ClassUnitsEffects } from './class-rooms.effects';
...
describe('ClassRoomsFacade', () => {
  ...
  describe('used in NgModule', () => {
    beforeEach(() => {
      @NgModule({
        imports: [
          StoreModule.forFeature(CLASS_ROOMS_FEATURE_KEY, classUnitsReducer),
