...
import { classUnitsReducer, ClassRoomsState, initialState } from './class-rooms.reducer';
...
describe('ClassRooms Reducer', () => {
  ...
  describe('valid ClassRooms actions', () => {
    it('getClassRoomsSuccess should return set the list of known ClassRooms', () => {
      ...
      const result: ClassRoomsState = classUnitsReducer(initialState, action);
  ...
  describe('unknown action', () => {
    it('should return the previous state', () => {
      ...
      const result = classUnitsReducer(initialState, action);
