export * from './lib/school-diary-domain.module';
...
export * from './lib/interfaces/items-pagination.interface';
...
export * from './lib/interfaces/subject.interface';
export * from './lib/interfaces/user.interface';
export * from './lib/interfaces/work-day.interface';
